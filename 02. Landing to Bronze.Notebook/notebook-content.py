...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "38d284f5-2714-4e79-bd74-4ac678ee9afc",
...
# #### 0.2 Landing to Bronze

# PARAMETERS CELL ********************

today_date = '9999-09-09'#'2025-03-31'
workspace="NA"
source_account = 'datalake22143' #primary account name 
source_container = 'fabricproject' #container name 
src_relative_path = 'landing' #relative folder path
...
# ### Upsert logic for inserting/updating data in the bronze table
