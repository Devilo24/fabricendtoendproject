...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "51147115-1cd7-4b5f-90d7-68347885b041",
# META       "default_lakehouse_name": "LH_gold",
# META       "default_lakehouse_workspace_id": "db418ed0-3c3a-4cd3-ad7f-08d470d103b5"
# META     }
# META   }
# META }
...
today_date = '9999-09-09'#'2025-03-31'
workspace="NA"
...
dim_delta_student =DeltaTable.forPath(spark,dim_student_table_path)

## Perform the MERGE (UPSERT)

dim_delta_student.alias('target').merge(
...
history_df = dim_delta_student.history(1)  # Get the latest operation
...
print('Total rows of table: ',dim_delta_student.toDF().count())
print("Merge Metrics:")
...
dim_delta_course =DeltaTable.forPath(spark,dim_course_table_path)


dim_delta_course.alias("target").merge(
...
# Get the history of the Delta table to extract metrics
history_df = dim_delta_course.history(1)  # Get the latest operation
...
print('Total rows of table: ',dim_delta_course.toDF().count())
print("Merge Metrics:")
print(f"Rows inserted: {rows_inserted}")
print(f"Rows updated: {rows_updated}")
print(f"Rows deleted: {rows_deleted}")
...
# MAGIC %%sql
# MAGIC 
# MAGIC SELECT * FROM LH_gold.dim_course LIMIT 1000
...
df_nodups =df_course.drop_duplicates()
